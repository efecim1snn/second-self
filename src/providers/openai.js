...
module.exports = {
  ...
  referenceMode: 'none',
  cost: 'kredili',
  costNote: 'Kare basina ucretlendirilir.',
  pricingUrl: 'https://openai.com/api/pricing/',
  realism: 'orta',
  realismNote: 'Temiz cikti verir ama SEED YOK - ayni yuzu birebir tekrarlamakta listedeki en zayif secenek.',
  maxResolution: '1024x1792',
  resolutionNote: 'Sabit olcu listesi var, serbest olcu kabul etmez.',
  setup: 'anahtar',
